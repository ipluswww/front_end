...
//subscribe to market data for trading pair
  this.getMarket = function (base, trade) {
    ...
    function addListeners() {
      ...
      asks = PortalOrderbook.OrderBook.createOrderBook(r, {
      ...
      bids = PortalOrderbook.OrderBook.createOrderBook(r, {
...
//handle data returned from Portal-lib
...
//draw the chart data loaded from Portal-lib
