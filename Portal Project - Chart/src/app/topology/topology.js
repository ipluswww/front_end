angular.module( 'portalobject.topology', [
  'ui.state',
  'ui.bootstrap'
])
...
.config(function config( $stateProvider ) {
  $stateProvider.state( 'topology', {
    ...
    data:{ pageTitle: 'Portald Topology Network' },
    resolve : {
...
.controller('TopologyCtrl', function TopologyCtrl($scope, $http, gateways) {
  ...
  $http
  .get(API + '/network/Portald_versions')
  .then(function(d) {
  ...
  // API endpoint: https://data-staging.Portal.com/v2/network/topology/nodes?verbose=true
