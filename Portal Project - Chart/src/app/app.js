...
angular.element(document).ready(function() {
  angular.module('portalobject', [
    'templates-app',
    'templates-common',
    'portalobject.landing',
    'portalobject.markets',
    'portalobject.manage-currencies',
    'portalobject.manage-gateways',
    'portalobject.multimarkets',
    'portalobject.activeAccounts',
    'portalobject.trade-volume',
    'portalobject.graph',
    'portalobject.accounts',
    'portalobject.transactions',
    'portalobject.value',
    'portalobject.history',
    'portalobject.metrics',
    'portalobject.topology',
    'portalobject.validators',
    'portalobject.validator',
    'portalobject.external-markets',
    'ui.state',
    'ui.route',
    'snap',
    'gateways',
  ...
  .controller('AppCtrl', function AppCtrl($scope, gateways) {
    ...
    $scope.$on('$stateChangeSuccess', function(event, toState) {
      ...
      if (angular.isDefined(toState.data.pageTitle)) {
        $scope.pageTitle = toState.data.pageTitle + ' | Portal Charts'

      } else {
        $scope.pageTitle = 'Portal Charts'
      }
    })

    // connect to the Portal network
    remote = new Portal.PortalAPI(Options.Portal)
  ...
  function checkStatus() {
    api.getMaintenanceStatus(function(err, resp) {
      ...
      if (!started && mode !== 'maintenance') {
        angular.bootstrap(document, ['portalobject'])
        started = true
      }
