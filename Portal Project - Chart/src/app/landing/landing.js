...
angular.module('portalobject.landing', [
  'ui.state'
])
...
.controller('LandingCtrl', function LandingCtrl($scope, $state, gateways) {
  ...
  var valueCurrencies = {
    ...
    CNY: 'rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y', // Portalfox
    XRP: ''
  }
  ...
  $scope.metrics = {
    ...
    tradeVolumeRCL: {
      label: 'Portal Network Trade Volume <small>(All Pairs)<small>',
      link: '#/trade-volume'
    },
    paymentVolumeRCL: {
      label: 'Portal Network Payment Volume'
    },
    capitalizationXRP: {
      label: 'XRP Capitalization'
    },
    numAccounts: {
      label: '# of Portal Accounts'
    }
  }
