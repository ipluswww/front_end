...
```
  ...
  apiURL    : custom url for the API backend, defaults to portalobject.com API
...
```
<iframe src='http://portalobject.com/embed/pricechart?theme=dark&type=line&counter={"currency":"USD","issuer":"rvYAfWj5gh67oV6fW32ZzP3Aw4Eubs59B"}&base={"currency":"XRP"}&live=true'/>
```

####Javascript object:

```
<script type="text/javascript" src="http://portalobject.com/embed/pricechart/script.js"></script>
<script>
...
```
<iframe src='http://portalobject.com/embed/ticker?markets=
[
  {
    "base": {"currency":"XRP"},
    "counter": {"currency":"USD","issuer":"rMwjYedjc7qqtKYVLiAccJSmCwih4LnE2q"}
...
```
<script type="text/javascript" src="http://portalobject.com/embed/ticker/script.js"></script>
