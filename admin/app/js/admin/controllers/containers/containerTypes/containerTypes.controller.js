...
class ContainerTypesController {

	constructor ($q, User, ContainerTypes, QueryData, $rootScope, $state, $window){
		this._$q = $q;
		this._User = User;
	...
	init () {
		...
		this.query = this._QueryData.getQuery('containerTypes') || this.query;
		...
		this._$rootScope.$on('$stateChangeStart',
			function(event, toState, toParams, fromState, fromParams){
				if (fromState.name === 'app.admin.containerTypes.list') self._QueryData.setQuery('containerTypes', self.query);
			});
	}
...
ContainerTypesController.$inject = ['$q', 'User', 'ContainerTypes', 'QueryData', '$rootScope', '$state', '$window'];
export default ContainerTypesController;
